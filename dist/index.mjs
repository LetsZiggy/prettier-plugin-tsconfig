import {orderGrouped as $6422d5c7c25045c4$export$f26f8765515284a1, orderTop as $6422d5c7c25045c4$export$acb82d2a2cee14d1} from "./plugin.c75acb79.js";
...
function $74a3580aa4356479$var$preprocess(text, options) {
    return (0, $bmXR4$stripjsoncomments)(text, {
        whitespace: true,
        trailingCommas: true
    }).replaceAll(/[\n\r]+/g, "").replaceAll("\t", "").replaceAll(": ", ":").replaceAll(", ", ",").replaceAll("{ ", "{").replaceAll(" }", "}").replaceAll("[ ", "[").replaceAll(" ]", "]");
}
